...
class Transformation:
    ...
    def __init__(self, n, max_hours_stores=10):
        ...
        self.BatteryUnitBlock_parameters = {
            ...
            "ExtractingBatteryRho": lambda efficiency_dispatch: efficiency_dispatch,
            "StoringBatteryRho": lambda efficiency_store: efficiency_store,
            "Demand": 0.0,
            "MinStorage": lambda p_nom_opt, p_min_pu, max_hours: p_nom_opt * p_min_pu * max_hours,
        ...
        self.BatteryUnitBlock_store_parameters = {
            ...
            "Demand": 0.0,
            "MinStorage": lambda e_nom_opt, e_min_pu: e_nom_opt * e_min_pu,
    ...
    def add_dimensions(self, n):
        components = {
            ...
            "NumberElectricalGenerators": ["generators"],
            "NumberNodes": ["buses"],
                ...
                for param in param_names:
                    ...
                    if param in components_t:
                        ...
                        if not df.empty and components_df.name in df.columns:
                            ...
                            args.append(components_df.get(param))
                    else:
                        args.append(components_df.get(param))
    ...
    def iterate_components(self, n):
        ...
        TODO dare regole serie per definire quale component corrisponde al blocco
        ...
        for components in n.iterate_components(["Line", "Generator", "Link", "Store", "StorageUnit"]):
            ...
            components_df = components.df
            # if len(components_df[components_df[f"{nominal_attrs[components.name]}_opt"] > 0]) > 0:
            #     components_df = components_df[components_df[f"{nominal_attrs[components.name]}_opt"] > 0]
            # else:
            #     continue
            ...
            if components_type == 'lines':
                ...
                self.add_UnitBlock(attr_name, components_df, components_t)
